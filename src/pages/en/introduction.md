...
| Stage | Description |
|-------|-------------|
| **Capture** | Lightweight L4 capture on production nodes |
| **Store** | Complete PCAP data retained for full history |
| **Analyze** | L7 dissection on-demand or scheduled |
| **Enrich** | Add Kubernetes context (pods, services, namespaces) |
