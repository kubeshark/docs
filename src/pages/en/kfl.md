...
[**Kubeshark Filter Language (KFL)**] is a rich query language that filters traffic that match a query. For example; to only see the items with HTTP client error responses (`400` – `499`), enter:
