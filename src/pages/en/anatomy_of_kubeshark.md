...
> Checkout the [live demo portal](https://demo.kubeshark.com), running on EKS using Ingress over HTTPS connected to an IDP and many other features live.
...
> Read more about the TTL strategy [here](https://docs.kubeshark.com/en/traffic_retention).
