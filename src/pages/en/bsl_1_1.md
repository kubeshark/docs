...
**License**: License to use the Licensed Work. License can be obtained either by browsing to https://kubehq.com/pricing, https://console.kubehq.com/ or by running `kubeshark pro` from the terminal.
