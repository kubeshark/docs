...
export const SIDEBAR: Sidebar = {
  en: {
    ...
    'AI Integration': [
      ...
      { text: 'Incident Investigation', link: 'en/mcp/incident_investigation' },
      { text: 'Security Analysis', link: 'en/mcp/security_analysis' },
      { text: 'Architecture Discovery', link: 'en/mcp/architecture_discovery' },
      { text: 'Performance Debugging', link: 'en/mcp/performance_debugging' },
      { text: 'Compliance & Auditing', link: 'en/mcp/compliance_auditing' },
      { text: 'Troubleshooting', link: 'en/mcp/troubleshooting' },
      { text: 'Autonomous Development', link: 'en/mcp/autonomous_development' },
      { text: 'Onboarding & Learning', link: 'en/mcp/onboarding' },
