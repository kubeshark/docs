...
export const SIDEBAR: Sidebar = {
  en: {
    ...
    'Core Concepts': [
      ...
      { text: 'Traffic Indexing', link: 'en/v2/l7_api_dissection' },
    ...
    'Dashboard': [
      ...
      { text: 'Workload Dependency Map', link: 'en/v2/service_map' },
      ...
      // { text: 'Disabling Real-time Indexing', link: 'en/on_off_switch' },
    ],
    'Helm Configuration': [
    ...
    'Traffic Filters': [
      { text: 'Capture Filters', link: 'en/pod_targeting' },
      { text: 'KFL Reference', link: 'en/v2/kfl2' },
